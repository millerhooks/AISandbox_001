RELEASE NOTES & TODO ITEMS:
		2.5.1:
			Native Mode Changes:
		        ! Viseme indexing issue no longer causes visual "pop" at the end of sentences and presents a more accurate lipsync.
		        + Added 7 viseme configuration.
		        ~ Modified recommended SALSA settings.
		2.5.0:
			+ Supports AND requires RT-Voice 2020.4.5.
			~ Requires Unity v2018.4+ (RT-Voice Requirement).
        2.0.1:
            + Supports RT-Voice 2019.4.
            ~ Minimum Unity version requirement 2017.4 (for RT-Voice).
            ~ Separates iOS native voice package with TextSync requirement.
        2.0.0-beta:
            + initial release for SALSA LipSync Suite.

LOCATION OF FILES:
	Assets\Crazy Minnow Studio\Addons\SalsaRtVoice
...
PURPOSE: This script provides a very simple integration of SALSA LipSync with
	Crosstales RT-Voice. There is a scene that demonstrates 3 modes of operation.
KNOWN ISSUES: none.
